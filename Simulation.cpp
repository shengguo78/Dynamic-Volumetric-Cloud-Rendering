...
bool CSimulationSpace::NewByteSpace( int size, PBYTE *ppBitSpace )
{
...
bool CSimulationSpace::NewFloatSpace( int size, PFLOAT *ppFloatSpace )
{
...
{
	SAFE_DELETE_ARRAY( m_pShapeSpace );
	SAFE_DELETE_ARRAY( m_pHumProbSpace );
	SAFE_DELETE_ARRAY( m_pExtProbSpace );
	SAFE_DELETE_ARRAY( m_pActProbSpace );
	SAFE_DELETE_ARRAY( m_apHumSpace[0] );
	SAFE_DELETE_ARRAY( m_apHumSpace[1] );
	SAFE_DELETE_ARRAY( m_apCldSpace[0] );
	SAFE_DELETE_ARRAY( m_apCldSpace[1] );
	SAFE_DELETE_ARRAY( m_apActSpace[0] );
	SAFE_DELETE_ARRAY( m_apActSpace[1] );
	SAFE_DELETE_ARRAY( m_pActFactorSpace );
	SAFE_DELETE_ARRAY( m_apDensitySpace[0] );
	SAFE_DELETE_ARRAY( m_apDensitySpace[1] );
	SAFE_DELETE_ARRAY( m_pMidDensitySpace );
}
...
float CSimulationSpace::GetPointDensity( D3DXVECTOR3 *pvPoint )
{
	int i = (int)pvPoint->x;
	int j = (int)pvPoint->y;
	int k = (int)pvPoint->z;
...
bool CSimulationSpace::IsPointInSpace( D3DXVECTOR3 *pvPoint )
{
...
//-----------------------------------------------------------------------------
void CSimulationSpace::CalculateDensity( UINT uPhaseIndex )
{
	int	index;
	for( int i = 0; i < m_iLength; i++ )
	{
...
//-----------------------------------------------------------------------------
void CSimulationSpace::CelluarAutomate(UINT uPhaseIndex)
{
...
//-----------------------------------------------------------------------------
void CSimulationSpace::GrowCloud(UINT uPhaseIndex)
{
	int index;
...
void CSimulationSpace::ExtinctCloud( UINT uPhaseIndex )
{
	int index;
...
void CSimulationSpace::SupplyVapor( UINT uPhaseIndex )
{
	int index;
...
void CSimulationSpace::UpdateActFactorSpace(UINT uPhaseIndex)
{
	for( int i = 0; i < m_iLength; i++ )
	{
		for( int j = 0; j < m_iHeight; j++)
...
void CSimulationSpace::SetByteCell( PBYTE pByteSpace, int i, int j, int k, BYTE value )
{
...
BYTE CSimulationSpace::GetByteCell( PBYTE pByteSpace, int i, int j, int k )
{
