...
extern __m128i __cdecl _mm_blend_epi16 (__m128i v1, __m128i v2,
                                        const int mask);
extern __m128i __cdecl _mm_blendv_epi8 (__m128i v1, __m128i v2, __m128i mask);

/*
 * Float single precision blend instructions - select data 
 * from 2 sources using constant/variable mask
 */
extern __m128  __cdecl _mm_blend_ps (__m128  v1, __m128  v2, const int mask);
extern __m128  __cdecl _mm_blendv_ps(__m128  v1, __m128  v2, __m128 v3);     

/*
 * Float double precision blend instructions - select data 
 * from 2 sources using constant/variable mask
 */
extern __m128d __cdecl _mm_blend_pd (__m128d v1, __m128d v2, const int mask);
extern __m128d __cdecl _mm_blendv_pd(__m128d v1, __m128d v2, __m128d v3);    

/*
 * Dot product instructions with mask-defined summing and zeroing 
 * of result's parts 
 */
extern __m128  __cdecl _mm_dp_ps(__m128  val1, __m128  val2, const int mask);
extern __m128d __cdecl _mm_dp_pd(__m128d val1, __m128d val2, const int mask);

/*
 * Packed integer 64-bit comparison, zeroing or filling with ones
 * corresponding parts of result
 */
extern __m128i __cdecl _mm_cmpeq_epi64(__m128i val1, __m128i val2);

/*
 * Min/max packed integer instructions 
 */
extern __m128i __cdecl _mm_min_epi8 (__m128i val1, __m128i val2);
extern __m128i __cdecl _mm_max_epi8 (__m128i val1, __m128i val2);
extern __m128i __cdecl _mm_min_epu16(__m128i val1, __m128i val2); 
extern __m128i __cdecl _mm_max_epu16(__m128i val1, __m128i val2); 
extern __m128i __cdecl _mm_min_epi32(__m128i val1, __m128i val2); 
extern __m128i __cdecl _mm_max_epi32(__m128i val1, __m128i val2); 
extern __m128i __cdecl _mm_min_epu32(__m128i val1, __m128i val2); 
extern __m128i __cdecl _mm_max_epu32(__m128i val1, __m128i val2); 

/*
 * Packed integer 32-bit multiplication with truncation
 * of upper halves of results
 */
extern __m128i __cdecl _mm_mullo_epi32(__m128i a, __m128i b);

/*
 * Packed integer 32-bit multiplication of 2 pairs of operands
 * producing two 64-bit results
 */
extern __m128i __cdecl _mm_mul_epi32(__m128i a, __m128i b);

/*
 * Packed integer 128-bit bitwise comparison.
 * return 1 if (val 'and' mask) == 0
 */
extern int __cdecl _mm_testz_si128(__m128i mask, __m128i val);

/*
 * Packed integer 128-bit bitwise comparison.  
 * return 1 if (val 'and_not' mask) == 0
 */
extern int __cdecl _mm_testc_si128(__m128i mask, __m128i val);
 ...
 */
extern int __cdecl _mm_testnzc_si128(__m128i mask, __m128i s2);
 ...
 * mask for dst
 */
extern __m128 __cdecl _mm_insert_ps(__m128 dst, __m128 src, const int ndx);
...
extern __m128i __cdecl _mm_insert_epi32(__m128i dst, int s, const int ndx);

#if defined(__x86_64) || defined(_M_X64)
extern __m128i __cdecl _mm_insert_epi64(__m128i dst, __int64 s, const int ndx);     
#endif
 ...
 */
extern __m128i __cdecl _mm_minpos_epu16(__m128i shortValues);

/*
 * Packed/single float double precision rounding 
 */
extern __m128d __cdecl _mm_round_pd(__m128d val, int iRoundMode);
extern __m128d __cdecl _mm_round_sd(__m128d dst, __m128d val, int iRoundMode);

/*
 * Packed/single float single precision rounding 
 */
extern __m128  __cdecl _mm_round_ps(__m128  val, int iRoundMode);
extern __m128  __cdecl _mm_round_ss(__m128 dst, __m128  val, int iRoundMode);

/*
 * Packed integer sign-extension 
 */
extern __m128i __cdecl _mm_cvtepi8_epi32 (__m128i byteValues);  
extern __m128i __cdecl _mm_cvtepi16_epi32(__m128i shortValues); 
extern __m128i __cdecl _mm_cvtepi8_epi64 (__m128i byteValues);  
extern __m128i __cdecl _mm_cvtepi32_epi64(__m128i intValues);   
extern __m128i __cdecl _mm_cvtepi16_epi64(__m128i shortValues); 
extern __m128i __cdecl _mm_cvtepi8_epi16 (__m128i byteValues);  

/*
 * Packed integer zero-extension 
 */
extern __m128i __cdecl _mm_cvtepu8_epi32 (__m128i byteValues); 
extern __m128i __cdecl _mm_cvtepu16_epi32(__m128i shortValues);
extern __m128i __cdecl _mm_cvtepu8_epi64 (__m128i shortValues);
extern __m128i __cdecl _mm_cvtepu32_epi64(__m128i intValues);  
extern __m128i __cdecl _mm_cvtepu16_epi64(__m128i shortValues);
extern __m128i __cdecl _mm_cvtepu8_epi16 (__m128i byteValues); 

/*
 * Pack 8 double words from 2 operands into 8 words of result
 * with unsigned saturation
 */
extern __m128i __cdecl _mm_packus_epi32(__m128i val1, __m128i val2);
...
extern __m128i __cdecl _mm_stream_load_si128(__m128i* v1);   
